 ...
 * Exposes window.mapboxgl with enough surface area to satisfy app.js / map.js / markers.js.
 *
...
window.mapboxgl = (() => {
  class MockMap {
    ...
    setStyle(url) {
      this._style = url;
      setTimeout(() => {
        // Reset sources and layers to simulate Mapbox's style-reload behaviour.
        this._layers  = [];
        this._sources = {};
        window.__mapLayers  = this._layers;
        window.__mapSources = this._sources;
